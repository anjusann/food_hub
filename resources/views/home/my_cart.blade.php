    ...
    <div>
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{$data->quantity}}</td>
                <td>
                    <img width="150 " alt=" " src="food_img/{{$data->image}}">
                    </td>
                    <td> <a onclick="return confirm('Are you sure want to remove this item')" class="btn btn-danger" href="{{url('remove_cart',$data->id)}}">Remove</a>
