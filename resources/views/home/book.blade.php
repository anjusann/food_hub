        ...
        <form action="{{ url('book_table') }}" method="POST">
            ...
            <div class="row mb-5">
                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                    <input type="text" name="phone" class="form-control form-control-lg custom-form-control" placeholder="Phone Number">
                </div>

                <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                    <input type="number" name="n_guest" class="form-control form-control-lg custom-form-control" placeholder="NUMBER OF GUESTS" max="20" min="1">
                </div>
